...
from gett.network_building import causality
import pdb
...
samples, genenames, Mexp = gett.io_utils.read_expression_matrix(args.expfile)
...
labels, Mgen = gett.io_utils.read_genotype_matrix(args.genmatfile, skip_fields=args.skip)
